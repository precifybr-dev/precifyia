...
import { DollarSign, AlertTriangle, TrendingUp, Calculator, ArrowRight } from "lucide-react";
...
export function DemoSection() {
  ...
  const calculations = useMemo(() => {
    ...
    const grossProfit = salePriceNum - costNum;
    ...
    const isValid = salePriceNum > 0 && costNum >= 0;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4">
            Veja quanto você está deixando na mesa agora
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Preencha com os dados de um produto e descubra se está lucrando ou
            perdendo dinheiro no iFood.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl bg-muted/50 border border-border">
                      ...
                      <p className="text-2xl font-bold text-foreground">
                        R$ {formatCurrency(calculations.grossProfit)}
                      </p>
                    </div>
          ...
          <div className="text-center mt-10">
            <p className="text-lg font-semibold text-foreground mb-2">
              Quer calcular todos os seus produtos com precisão?
            </p>
