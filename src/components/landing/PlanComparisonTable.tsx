...
const comparisonData: ComparisonRow[] = [
  ...
  { feature: "Análise de cardápio (IA)", free: "1 (total no período)", essencial: "5/mês", pro: "15/mês" },
  { feature: "Combos estratégicos (IA)", free: "1 (total no período)", essencial: "3/mês", pro: "10/mês" },
  ...
  { feature: "Suporte", free: "Padrão", essencial: "Padrão", pro: "Prioritário WhatsApp" },
];
