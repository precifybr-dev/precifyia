...
const fallbackPlans: PricingPlan[] = [
  {
    ...
    features: [
      ...
      { text: "1 análise de cardápio (total no período)", included: true },
      { text: "1 combo estratégico (total no período)", included: true },
      { text: "1 importação iFood (total no período)", included: true },
      { text: "2 importações de planilha (total no período)", included: true },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "7 importações de planilha/mês", included: true },
      { text: "Sub-receitas ilimitadas", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "10 combos estratégicos/mês", included: true },
