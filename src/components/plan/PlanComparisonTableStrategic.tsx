...
const comparisonData: ComparisonRow[] = [
  ...
  { feature: "Dashboard", free: "Avançado + DRE", essencial: "Avançado + DRE", pro: "Avançado + DRE" },
  { feature: "Análise de cardápio (IA)", tooltip: AI_TOOLTIP, free: "1 (total no período)", essencial: "5/mês", pro: "15/mês" },
  { feature: "Combos estratégicos (IA)", tooltip: AI_TOOLTIP, free: "1 (total no período)", essencial: "3/mês", pro: "10/mês" },
  { feature: "Importação iFood", free: "1 (total no período)", essencial: "5/mês", pro: "Ilimitada" },
  { feature: "Importação de planilha", free: "2 (total no período)", essencial: "7/mês", pro: "Ilimitada" },
  { feature: "Sub-receitas", free: "Até 3", essencial: "Ilimitado", pro: "Ilimitado" },
