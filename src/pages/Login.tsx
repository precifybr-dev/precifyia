...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero flex">
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center p-12 border-l border-border">
        <div className="max-w-md text-center">
          <div className="w-24 h-24 rounded-2xl bg-gradient-primary flex items-center justify-center mx-auto mb-8 shadow-glow">
